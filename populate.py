...
def my_parse():
    ...
    product = models.Products(name='Nokia 1100', description=description)
    product.save()
    save_img(
    ...
    product = models.Products(
        name='Samsung Galaxy S6', description=description)
    product.save()
    save_img(
    ...
    product = models.Products(name='BlackBerry Z10', description=description)
    product.save()
    save_img(
    ...
    test_quest = models.Questions(point_answer=50, point_emotions=-30, text_questions="Предложить товар",
